...
INSERT INTO "new_events" ("created_at", "grand_prix_id", "grand_prix_season_id", "id", "name", "start_at", "updated_at") SELECT "created_at", "grand_prix_id", "grand_prix_season_id", "id", "name", "start_at", "updated_at" FROM "events";
DROP TABLE "events";
